...
export const CertificatesSection: React.FC = () => {
  ...
  return (
    <section id="certificates" className="py-20 sm:py-28 border-b border-stone-200/80 dark:border-stone-800/80 bg-stone-50/50 dark:bg-stone-950/20">
          ...
          {certificates.map((cert) => (
            ...
            >
              <div>
                ...
                <div className="p-6 space-y-3">
                  ...
                  <div className="text-xs font-mono text-stone-600 dark:text-stone-400 space-y-1">
                    <p>
                      {t((d) => d.certificates.issuer)} <span className="text-stone-950 dark:text-white font-bold">{cert.issuer}</span>
                    </p>
                    <p>
                      {t((d) => d.certificates.credentialId)} <span className="text-stone-800 dark:text-stone-200">{cert.credentialId}</span>
                    </p>
                  </div>
              ...
              <div className="px-6 py-4 border-t border-stone-200 dark:border-stone-800 bg-stone-50 dark:bg-stone-900 flex items-center justify-between">
                <span className="text-xs font-mono font-medium text-stone-500 dark:text-stone-400">Verifiable Credential</span>
                <a

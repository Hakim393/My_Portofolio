...
import { Calendar, Building, Award, ArrowRight, Images } from 'lucide-react';
  ...
  return (
    <main id="main-content" className="pt-28 sm:pt-36 pb-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Category Filters */}
        <div className="flex flex-wrap items-center gap-2 mb-10 pb-6 border-b border-stone-200 dark:border-stone-800">
              ...
              <div>
                <div className="relative aspect-16/10 bg-stone-100 dark:bg-stone-950 overflow-hidden border-b border-stone-200 dark:border-stone-800">
                  ...
                  {act.gallery && act.gallery.length > 0 && (
                    <div className="absolute bottom-3 right-3 px-2.5 py-1 rounded bg-black/75 backdrop-blur-xs text-white text-[10px] font-mono flex items-center gap-1">
                ...
                <div className="p-6 space-y-3">
                  <div className="flex items-center gap-2 text-xs font-mono font-medium text-stone-600 dark:text-stone-400">
                    <Calendar className="w-3 h-3" />
                    <span>{act.date}</span>
                  </div>

                  <h3 className="text-lg font-bold text-stone-950 dark:text-white tracking-tight leading-snug">
                    <Link
                  ...
                  <p className="text-xs sm:text-sm text-stone-700 dark:text-stone-300 leading-relaxed line-clamp-3 pt-1">
